...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $cityaddrs = CityaddrModel::find()->orderby('city_id')->all();
        foreach($cityaddrs as $cityaddr){
            $arrCityaddr[$cityaddr->Id] = $cityaddr->city_addr;
        }
    ...
    {
        $this->redirect(\Yii::$app->urlManagerBackend->hostInfo);
    }
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->login()) {
            return $this->redirect(\Yii::$app->urlManagerBackend->baseUrl);//$this->goBack();
        } else {
            $model->password = '';
